-- Earlier apply of 20260422203000 used an overlong function name; Postgres truncated it to
-- governance_proposal_meets_guardian_relay_client_verification_di (63 chars). Install the
-- stable short name and drop the truncated symbol if present.
...
DROP FUNCTION IF EXISTS public.governance_proposal_meets_guardian_relay_client_verification_di(uuid);
