ALTER TABLE public.profiles
  ...
  ADD COLUMN IF NOT EXISTS full_name_change_count integer NOT NULL DEFAULT 0,
...
BEGIN
  ...
  IF TG_OP = 'UPDATE'
    ...
    IF coalesce(OLD.full_name_change_count, 0) >= 3 THEN
      RAISE EXCEPTION 'You can only change identity information 3 times during the first 7 days after signup.';
    END IF;
