...
- minimized trusted-backend rollout now includes replaceable verifier mirror registration, signed directory publication, failover-policy configuration, and probe-job automation baselines, but autonomous third-party mirror discovery, independent directory-signer governance, and federated mirror-policy ratification are not yet complete
