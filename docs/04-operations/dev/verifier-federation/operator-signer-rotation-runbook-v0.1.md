...
Operational steps for **Phase D** of `rollout-plan-v0.1.md` (same folder): rotate verifier mirror **directory signers**, **federation operators**, and **distribution cosigners** without breaking client-verifiable continuity or leaving execution gates stuck in a false “not ready” state. For **two-operator field rehearsal** (digest parity, distribution verification, escalation drills), use that document **§10** alongside this runbook.
