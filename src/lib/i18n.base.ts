export const baseTranslations = {
  ...
  "onboarding": {
    ...
    "summary": "A world-scale system to prevent harm, align interests, and help humanity live at the next level.",
    ...
    "pillarCitizenshipDescription": "One world identity and shared political and economic interests that transcend borders and zero-sum competition.",
    ...
    "productLead": "A live global network application — not just a manifesto. Members already use it for identity, study, governance, exchange, and protected participation.",
    ...
    "faqWhatAnswer": "Levela is a global network application for verified identity, civic learning, governance, fair exchange, and protected participation — built to help humanity live at the next level.",
  ...
  "auth": {
    ...
    "signupTitle": "Levela",
    "signupSubtitle": "Join the global network and live at the next level.",
    "forgotTitle": "Levela",
