export const baseTranslations = {
  ...
  "onboarding": {
    "title": "Levela",
    "slogan": "Live Next Level",
    "summary": "A planetary system to prevent harm, align interests, and help humanity live at the next level.",
    "pageTitle": "Levela — Live Next Level",
    "pageDescription": "Join a unified, open, decentralized planetary network built to prevent harm and war, advance planetary citizenship, and help humanity live at the next level.",
    ...
    "evilFraud": "Fraud",
    "evilImpersonation": "Impersonation",
    "evilLies": "Lies",
    ...
    "approachLead": "A unified system — open source, decentralized, and constantly audited — built on common political and economic interests for everyone.",
    "pillarUnifiedTitle": "Unified and auditable foundation",
    "pillarUnifiedDescription": "Open source software, decentralized governance, and continuous public auditing so no single actor can hide corruption or abuse.",
    "pillarUnifiedExample": "Public audits, open code, and no hidden control.",
    "pillarCitizenshipTitle": "Planetary citizenship",
    "pillarCitizenshipDescription": "One global identity and shared political and economic interests that transcend borders and zero-sum competition.",
    "pillarCitizenshipExample": "One identity and shared interests across borders.",
    "pillarInsuranceTitle": "Insurance and stewardship",
    "pillarInsuranceDescription": "Comprehensive insurance plus responsible management of human and planetary resources so need is met without exploitation.",
    "pillarInsuranceExample": "Protection and fair use of people and planet.",
    "pillarPrivacyTitle": "Privacy and universal standards",
    "pillarPrivacyDescription": "Meaningful privacy protections alongside mass standardization of rules, formats, and expectations everywhere.",
    "pillarPrivacyExample": "Real privacy with the same rules everywhere.",
    "trustLine": "Built in the open. Audited in public.",
    "detailsLabel": "More details",
    "joinNetwork": "Join the network",
    "signIn": "Sign in",
    "tryAndroidBuild": "Try the Android build",
    "tryAndroidBuildDescription": "Install the latest testing build on your phone while the planetary network expands.",
    ...
    "statusLiveMarket": "Market, LUMA wallet, and digital agreements",
    ...
    "productTitle": "What Levela is today",
    "productLead": "A live planetary network application — not just a manifesto. Members already use it for identity, study, governance, exchange, and protected participation.",
    ...
    "productProfileDescription": "Build a verified identity card with trust signals and endorsements.",
    "productGovernanceTitle": "Governance",
    "productGovernanceDescription": "Participate in policy, audits, and decentralized federation work.",
    "productMarketTitle": "Market and agreements",
    "productMarketDescription": "Trade, list services, and sign digital agreements with LUMA credits.",
    ...
    "afterJoinLead": "Create a free account to unlock the full network and start as a planetary citizen.",
    ...
    "learnMoreCharter": "Levela Charter",
    ...
    "faqWhatQuestion": "What is Levela?",
    "faqWhatAnswer": "Levela is a planetary network application for verified identity, civic learning, governance, fair exchange, and protected participation — built to help humanity live at the next level.",
    "faqGovernmentQuestion": "Is Levela a government or political party?",
    "faqGovernmentAnswer": "No. Levela is an open civic and economic network. It helps people coordinate with shared standards and interests; it does not replace states by itself.",
    "faqOpenSourceQuestion": "Is Levela open source?",
    "faqOpenSourceAnswer": "Yes. The project is developed in the open. You can review the repository, documentation, and governance materials before joining.",
    "faqWhoQuestion": "Who is Levela for?",
    "faqWhoAnswer": "Anyone who wants verified identity, fair participation, civic learning, and a decentralized path toward planetary cooperation — citizens, contributors, builders, and auditors.",
  ...
  "auth": {
    "loginTitle": "Levela",
    "loginSubtitle": "Welcome back to the planetary network.",
    "signupTitle": "Levela",
    "signupSubtitle": "Join the network and live at the next level.",
    "forgotTitle": "Levela",
  ...
  "settings": {
    ...
    "wallet": "Wallet",
    "walletDescription": "Balance, send Luma, activity, and marketplace payment history",
    "taxonomy": "Taxonomy",
    ...
    "walletPageSubtitle": "Your balance, transfers, and purchase history (Luma active now)",
    "walletBack": "Back to settings",
    "walletOpenMarket": "Open Marketplace",
    "walletSignIn": "Sign in on the home screen to manage your wallet here (Luma active now).",
  ...
  "market": {
    ...
    "searchBarPlaceholder": "What do you want to buy?",
  ...
  "home": {
    ...
    "accountSwitchBack": "Switch back",
    "accountSwitchBackSuccess": "Switched back to the previous account.",
    "accountSwitchBackFailed": "Could not switch back.",
