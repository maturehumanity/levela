export const baseTranslations = {
  ...
  "governanceHub": {
    ...
    "executeNotReady": "This proposal is not ready to run yet. Confirm guardian sign-off, voting thresholds, and verifier federation distribution readiness in the public audit verifier controls.",
